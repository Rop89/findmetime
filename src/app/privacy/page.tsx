...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Find me time</title>
        <meta name="description" content="Privacy Policy for Find me time app" />
      </Head>
      ...
      <div className="p-12">
        ...
        <div className="m-6 p-8 bg-white rounded-lg shadow-md border border-gray-300 max-w-3xl mx-auto">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-4 mb-2">Definitions</h3>
            <ul className="list-disc pl-5 text-gray-700 text-lg">
              ...
              <li><strong>Company</strong> refers to Find me time.</li>
              ...
              <li><strong>Website</strong> refers to Find me time, accessible from https://findmetime.netlify.app/</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 text-lg">
              Usage Data is collected automatically when using the Service. This data may include information such as Your Device's Internet Protocol address (e.g., IP address), browser type, pages of our Service that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers, and other diagnostic data.
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-4 mb-2">Cookies</h3>
            <p className="text-gray-700 text-lg">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-4 mb-2">Types of Cookies Used</h3>
            <ul className="list-disc pl-5 text-gray-700 text-lg">
              ...
              <li><strong>Functionality Cookies</strong>: These allow us to remember choices You make when You use the Website, such as remembering your login details or language preference.</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <br></br>
            <p className="text-gray-700 text-lg">Other legal requirements - The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul className="list-disc pl-5 text-gray-700 text-lg">
